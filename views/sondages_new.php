<div id="sondage_new">
  ...
  <div id="user_dialog" title="Ajouter une date">
    ...
    <div class="form-group">
      <label>Date </label>&nbsp;&nbsp;
      <input type="date" class="diag_sond_new" id="date" name="date" value=<?=date('Y-m-d')?> min=<?=date('Y-m-d')?> max="2050-12-31"  required >
...
// fonction qui attend que l'arbre dom soit complet.
