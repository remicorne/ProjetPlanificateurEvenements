...
<div id="sondage_new">
	...
	<form role="form" action="/index.php/evenements/sondages_add" method="post">
	  ...
	  <input type="date" id="date1" name="date1"
       value=<?=date('Y-m-d')?>
       min=<?=date('Y-m-d')?> max="2050-12-31">
	   &nbsp;&nbsp;&nbsp;
	   <input type="time" id="horaireD1" name="horaireD1"
       min="09:00" max="18:00" required>
	   &nbsp;&nbsp;&nbsp;
	   <input type="time" id="horaireF1" name="horaireF1"
       min="09:00" max="18:00" required>
	   </div>
       ...
       min=<?= date('Y-m-d')?> max="2050-12-31">
	   &nbsp;&nbsp;&nbsp;
	   <input type="time" id="horaireD2" name="horaireD2"
       min="09:00" max="18:00" required>
	   &nbsp;&nbsp;&nbsp;
	   <input type="time" id="horaireF2" name="horaireF2"
       min="09:00" max="18:00" required>
	   </div>
    <div>
	   <div>
       ...
       min=<?= date('Y-m-d')?>  max="2050-12-31">
	   &nbsp;&nbsp;&nbsp;
	   <input type="time" id="horaireD3" name="horaireD3"
       min="09:00" max="18:00" required>
	   &nbsp;&nbsp;&nbsp;
	   <input type="time" id="horaireF3" name="horaireF3"
       min="09:00" max="18:00" required>
	   </div>
	 </div><br>
